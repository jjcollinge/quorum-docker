...
ARGS="--rm -it -e BOOTNODE_ADDRESS=${BOOTNODE_ADDRESS} -e CONSTELLATION_PORT=${CONSTELLATION_PORT} -p 33445:33445 -p 8545:8545 -p 30303:30303 -p ${CONSTELLATION_PORT}:${CONSTELLATION_PORT} ${SERVICE_IMAGE_ID}"
